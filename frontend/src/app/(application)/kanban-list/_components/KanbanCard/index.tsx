...
export function KanbanCard({ task, isOverlay }: IProps) {
    ...
    return (
        <div
            ...
            style={style}
            className="group relative flex flex-col gap-2 p-3 bg-card hover:bg-card/80 border border-border/40 rounded-xl shadow-sm hover:shadow-md transition-all duration-200 cursor-grab active:cursor-grabbing touch-none"
        >
