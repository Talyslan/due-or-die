...
export function TaskList({ tasks }: IProps) {
    ...
    return (
        <div className="flex flex-col border rounded-lg h-full mb-5 max-h-[calc(100vh-180px)] overflow-hidden">
            <CustomLink
                href="/simple-list/?addTask=open"
                className="flex justify-start items-center gap-2 w-full rounded-b-none"
            >
                <PlusIcon />
